...
function RepoDetails() {
  ...
  useEffect(() => {
    fetch(`https://api.github.com/repos/OnshilAgassi8/${id}`)
  ...
  useEffect(() => {
    fetch(`https://api.github.com/repos/OnshilAgassi8/${id}/branches`)
      .then((response) => response.json())
      .then((data) => {
        setBranch(data);
      });
  ...
  useEffect(() => {
    fetch(`https://api.github.com/repos/OnshilAgassi8/${id}/deployments`)
      .then((response) => response.json())
      .then((data) => {
        setDeployment(data);
      });
      ...
      <div className="repodetail-card">
        ...
        <p>
          ...
          {deployment.length === 0 ? (
            ...
            <a href={`https://OnshilAgassi8.github.io/${details.name}`}>
              OnshilAgassi8.github.io/{details.name}
            </a>
          }
        </p>
        <p>
